 ...
 */
public class SpringEnhancerUtil2 {
	...
	public Object createProxyClazz(Class clazz) {
		...
		enhancer.setCallbacks(new Callback[]{new MyCallBack(), new MyCallBack2()});
...
//		enhancer.setCallbackTypes(CALLBACK_FILTER.getCallbackTypes());
	...
	public static void main(String[] args) {
		SpringEnhancerUtil2 springEnhancerUtil = new SpringEnhancerUtil2();
